          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 text-lg">
                Chúng tôi tự hào mang đến những món ăn chất lượng cao với hương vị độc đáo.
                Với hơn 10 năm kinh nghiệm trong ngành ẩm thực, chúng tôi luôn nỗ lực để
                mang đến trải nghiệm ẩm thực tuyệt vời nhất cho khách hàng.
              </p>
            ...
            {[1, 2, 3].map((item) => (
              ...
              >
                ...
                <p className="text-gray-600">
                  "Đồ ăn rất ngon, phục vụ nhanh chóng và nhiệt tình. Tôi sẽ quay lại!"
                </p>
              </motion.div>
            ))}
          </div>
