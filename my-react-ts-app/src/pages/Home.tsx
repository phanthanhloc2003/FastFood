      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            Đồ Ăn Nhanh Chất Lượng Cao
          </h1>
          <p className="text-xl md:text-2xl mb-8">
            Khám phá menu đa dạng với những món ăn ngon nhất
          </p>
          <motion.button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 text-lg">
                Chúng tôi tự hào mang đến những món ăn chất lượng cao với hương
                vị độc đáo. Với hơn 10 năm kinh nghiệm trong ngành ẩm thực,
                chúng tôi luôn nỗ lực để mang đến trải nghiệm ẩm thực tuyệt vời
                nhất cho khách hàng.
              </p>
              <ul className="space-y-3">
                {[
                  "Nguyên liệu tươi ngon, chất lượng cao",
                  "Đầu bếp chuyên nghiệp, giàu kinh nghiệm",
                  "Phục vụ nhanh chóng, nhiệt tình",
            ...
            {[1, 2, 3].map((item) => (
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  />
                  <div>
                    <h3 className="font-semibold">Khách hàng {item}</h3>
                ...
                <p className="text-gray-600">
                  "Đồ ăn rất ngon, phục vụ nhanh chóng và nhiệt tình. Tôi sẽ
                  quay lại!"
                </p>
              </motion.div>
            ))}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-4xl font-bold">Liên Hệ Chúng Tôi</h2>
              <p className="text-gray-600 text-lg">
                Hãy để lại thông tin, chúng tôi sẽ liên hệ với bạn sớm nhất có
                thể.
              </p>
